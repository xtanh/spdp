...
def process_entry(e):
    ...
    if data is None:
        print(f"'aa' data missing or None for PDB {pdbcode}. Skipping entry.")
        return None
...
if __name__ == "__main__":
    ...
    with open('/home/hongtan/pretrain_single/dataset/final_dataset/cache/entries.pkl', 'rb') as f:
    ...
    output_dir = '/home/hongtan/pretrain_single/dataset/final_dataset'
